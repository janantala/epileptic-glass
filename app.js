...
var insertHello = function(client, errorCallback, successCallback){
    ...
    .mirror.timeline.insert(
        {
            'title': 'Hello',
            'speakableType': 'Epileptic!',
            'html': '<h1 style="color: yellow; text-align: center; margin: 10px auto;">Hello epileptic world!</h1>'
                // + '<div><img src="http://media.tumblr.com/tumblr_ma3s80ynoJ1qg7p8h.gif" style="display: block; margin: 10px auto;"></div>',
                + '<div><img src="http://images.wikia.com/mrpeople/images/8/80/Epilepsy.gif" style="display: block; margin: 10px auto; width: 100%"></div>',
            'speakableText': 'Hello there! Are you still there?',
